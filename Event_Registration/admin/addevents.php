...
<body>
    ...
    <div class="vertical-nav bg-white" style="background-color: #f9f9f9 !important;" id="sidebar">
        <div class="py-4 px-3 mb-4 bg-light">
            ...
            <img style="width: 130px;height: 130px;border-radius: 50%;object-fit: cover;" src="../profiles/<?php echo $img; ?>"
                    class="iconimg mr-3 rounded-circle img-thumbnail shaadow-sm">
                <div class="media-body">
                    <h4 class="m-0">Admin</h4>
                    <p class="font-weight-norml text-muted mb-0"><?php echo $fname; ?></p>
                </div>
            </div>
        </div>
        <div>
    ...
    <div class="page-content p-5" id="content">
        ...
        <section style="padding-top:30px">
            <div class="w-50   text-white">
                <?php
                //inserting all the event details into database if button is pressedƒ
                if (isset($_POST["adde"])) {
                    extract($_POST);
